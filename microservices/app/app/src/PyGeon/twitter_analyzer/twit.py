...
TWITTER_HASHTAG = "GDDIndia"

# Mandrill
FROM_EMAIL_ADDRESS = "sendeexampexample@example.com"
FROM_EMAIL_NAME = "Event Bot"
TO_EMAIL_ADDRESS = "shreyas.gopal.ind@gmail.com"
TO_EMAIL_NAME = "Shreyas Gopal"
...
class SEND:
    ...
    def sendSms(self, sms_text):
        ...
        try:
            ...
            client = boto3.client(
                "sns",
                aws_access_key_id="AKIAJL2MKT6N7HWSZP6A",
                aws_secret_access_key="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",
...
def email(FROM, TO, SUBJECT, TEXT):
    ...
    print "DEBUG"
    headers = {
        'Authorization': "Bearer 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",
